...
1. Open a new browser tab, and go to [lodsprodmslearnmca.sharepoint.com/_layouts/15/sharepoint.aspx](https://lodsprodmslearnmca.sharepoint.com/_layouts/15/sharepoint.aspx).
