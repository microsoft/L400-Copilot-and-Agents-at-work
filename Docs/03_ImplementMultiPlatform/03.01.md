---
title: '01. Create a basic Foundry agent'
layout: default
nav_order: 1
parent: 'Exercise 03: Implement multi-platform agents solutions'
---

## Task 01: Create a basic Foundry agent
...
1. Sign in by using the following credentials:
	...
	> If the New Foundry option is disabled, enable the feature before proceeding.
	>
	> ![tz21x3b2.jpg](../../media/tz21x3b2.jpg)
...
1. Select **Models** and then select **Deploy a base model**.
...
1. Name the agent `zava-store-private-bank-detail-bot` then select **create**.
...
1. Paste the value into the following text field:
