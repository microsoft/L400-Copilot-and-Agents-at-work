---
title: '04. Connect the agent to the Zava Retail Help Desk Bot in Copilot Studio'
layout: default
nav_order: 4
parent: 'Exercise 03: Implement multi-platform agents solutions'
---

## Task 04: Connect the agent to the "Zava Retail Help Desk Bot" in Copilot Studio
