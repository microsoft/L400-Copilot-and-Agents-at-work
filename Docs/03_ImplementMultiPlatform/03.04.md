---
title: '04. Test the Foundry agent connected functionalities from Copilot Studio'
layout: default
nav_order: 4
parent: 'Exercise 03: Implement multi-platform agents solutions'
---

## Task 04: Test the Foundry agent connected functionalities from Copilot Studio
...
1. Submit the following prompt and review the response:
	...
	{: .warning }
    > You may see a message asking to help get you connected. If you see this message, select **Open connection manager** and follow the instructions to connect to **Azure AI Foundry Agent Service**. Then, resubmit the prompt in a **new test session**.
	>
	> ![tchw1uf8.jpg](../../media/tchw1uf8.jpg)
	>
	>![trggl603.jpg](../../media/trggl603.jpg)
