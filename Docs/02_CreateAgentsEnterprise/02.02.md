...
1. Open a new Edge browser tab and go to `https://github.com/okalb/40-505-50/blob/main/openai_custom_connector/publicpage_openapi.json`.
...
1. On the command bar for the **publicpage_openapi.json** page, select **Download raw file**.
	...
	![29i39evo.jpg](../../media/29i39evo.jpg)
...
1. Go back to the **Copilot Studio** page.
...
1. Refresh the page. the **ZavaOpenAPICall** tool will display.
