---
title: '01. Create and configure a Copilot Studio agent, then enrich it by adding SharePoint‑based knowledge sources'
layout: default
nav_order: 1
parent: 'Exercise 02: Create agents for enterprise integrations'
---

## Task 01: Create and configure a Copilot Studio agent, then enrich it by adding SharePoint‑based knowledge sources
...
1. Enter the following text and then select **Save**.
	...
	* Do not allow HR‑related private data to flow into Marketing contexts.
	* Do not allow Marketing operational data to influence HR decisions.
	* Follow enterprise data governance rules at all times.
